...
class ExtendedFaradayModel:
    ...
    def generate_extended_samples(
        ...
        Args:
            ...
            n_samples (int): Number of synthetic samples to generate. This argument
                specifies the number of stitched-together samples. In practice, this
                means that more samples will be generated by the Faraday model. For
                instance, if generating samples for January, `n_samples` * 31 will be
                generated and stitched together to produce `n_samples` samples with
                31 days.
